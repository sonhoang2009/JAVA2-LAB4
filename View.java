...
public class View {
    ...
    public static void top10newset() {
        try(
            ...
            while(rst.next()){
                ...
                System.out.println("id,title,author,years,genre,status,qty,price");
            }
    ...
    public static void topSeller(){
        try(
            ...
            while(rst.next()){
                ...
                System.out.println("id,title,author,years,genre,status,qty,price,soldamount");
            }
            System.out.println("**Status: 1-Out of stock, 2-available, 3-available soon**\n" +
                    "====================================================================================================================================");
        }catch (SQLException ex){
    ...
    public static void findBookByCatetory(){
        Scanner scanner = new Scanner(System.in);
